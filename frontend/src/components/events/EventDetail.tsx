...
const EventDetail: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen pb-16">
      ...
      <div className="w-full h-72 md:h-96 bg-gray-300 dark:bg-gray-700 relative overflow-hidden">
        <img
          src={event.imageUrl}
          alt={event.title}
        ...
        <button
          ...
          className="absolute top-4 left-4 bg-white dark:bg-gray-800 p-2 rounded-full shadow-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
        >
          <svg
